...
//Custom Factory Compiles
createRandomPilot = [_path, "createUnits\createRandomPilot.sqf"] call mf_compile; // Hostile Jet Create Pilot
...
fn_invis = [_path, "invis.sqf"] call mf_compile; // Admin Panel Invis Server side
