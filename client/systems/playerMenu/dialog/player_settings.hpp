...
class playerSettings {
	...
	class controlsBackground {
		...
		class waterText : w_RscText {
			...
			text = "";
			sizeEx = 0.03;
			x = -0.11; y = 0.153; // x = -0.022; y = 0.153;
			w = 0.3; h = 0.05;
		};
