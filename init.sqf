...
if (!isDedicated) then
{
	[] spawn
	{
		...
		{
			9999 cutText ["Welcome Strayagaming Wasteland, Please wait for your client to initialize. (DO NOT RESPAWN! YOU WILL LOSE YOUR BANK ACCOUNT!)", "BLACK", 0.01];
...
if (hasInterface || isServer) then
{
	...
	//[] execVM "addons\R3F_ARTY_AND_LOG\init.sqf"; Old R3F
	[] execVM "addons\R3F_LOG\init.sqf"; // R3F 3.1 Upgrade
